  ...
  <div class="app-user">
    <div class="media">
      ...
      <div class="media-body">
        <div class="foldable">
          <h5><a href="javascript:void(0)" class="username">Mehmet Temizce</a></h5>
          <ul>
            <li class="dropdown">
      ...
      <ul class="app-menu">
        ...
        <li class="has-submenu">
          <a href="javascript:void(0)" class="submenu-toggle">
            ...
            <span class="menu-text">Sandık Bölgeleri</span>
        ...
        <li class="has-submenu">
          <a href="javascript:void(0)" class="submenu-toggle">
            ...
            <span class="menu-text">Görevliler</span>
            <i class="menu-caret zmdi zmdi-hc-sm zmdi-chevron-right"></i>
          </a>
          <ul class="submenu">
        ...
        <li class="has-submenu">
          <a href="javascript:void(0)" class="submenu-toggle">
            ...
            <span class="menu-text">E-Posta Kutusu</span>
            <i class="menu-caret zmdi zmdi-hc-sm zmdi-chevron-right"></i>
          </a>
          <ul class="submenu">
            <li>
              <a href="inbox.html">
                <span class="menu-text">Gelen</span>
        ...
        <li>
          <a href="search.web.html">
            ...
            <span class="menu-text">Arama Yap</span>
          </a>
        </li>
        ...
        <li class="has-submenu">
          <a href="javascript:void(0)" class="submenu-toggle">
            ...
            <span class="menu-text">Oy Giriş Paneli</span>
            <i class="menu-caret zmdi zmdi-hc-sm zmdi-chevron-right"></i>
          </a>
          <ul class="submenu">
            <li><a href="profile.html"><span class="menu-text">Bölgeler</span></a></li>
